        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSender.SendEmailAsync(
                    ...
                    $"Proszę potwierdź swoje konto <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Kliknij tu</a>.");

                StatusMessage = "Link potwierdzający zmianę wysłano na adres e-mail. Proszę sprawdzić email.";
                return RedirectToPage();
            }

            StatusMessage = "Twój adres e-mail pozostaje niezmieniony.";
            return RedirectToPage();
        }
