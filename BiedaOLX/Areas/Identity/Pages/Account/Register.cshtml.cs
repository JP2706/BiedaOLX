...
namespace BiedaOLX.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            IMyAppUserService myAppUserService)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var myuser = new MyAppUser {UserId = user.Id, UserName = Input.UserNameName};
                    _myAppUserService.Add(myuser);
